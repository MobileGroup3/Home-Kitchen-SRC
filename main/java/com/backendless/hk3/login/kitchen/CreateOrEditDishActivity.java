...
//                    progress.dismiss();
                ...
                public void handleFault(BackendlessFault fault) {
                    Log.i("dishItem save failed",fault.getMessage()+" "+fault.getDetail());
//                    progress.dismiss();
                }
            });
        }
//        progress = ProgressDialog.show(CreateOrEditDishActivity.this, "upload",
//             "uploading dishItem", true);
        ...
        if(resultCode==RESULT_OK){
            if(requestCode==DISHPIC_REQUEST){
                ...
                try{
                    ...
                    ivDishPic.setImageBitmap(bitmap);
